...
> [!TIP]
> 开发者碎碎念：经过连续 3 天的高强度开发和实机测试，`v1.8.16` 先在这里暂时告一段落了。  
> 撒花，撒花，撒花。  
> 如果你在使用过程中遇到问题，欢迎继续提 [Issues](https://github.com/Cooper-X-Oak/LongYinMod_RisingFame/issues)。  
> 也感谢人生中的第一批 Star 支持，这个仓库能走到现在，真的很开心。
